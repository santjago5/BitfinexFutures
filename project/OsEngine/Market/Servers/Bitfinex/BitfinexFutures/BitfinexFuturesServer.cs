        ...
        private void UpdatePosition(string message)
        {
            try
            {
                ...
                if (data.Length >= 3)
                {
                    ...
                    {
                        SendLogMessage("UpdatePosition error: positionArray invalid", LogMessageType.Error);
                        return;
                    }
                    ...
                    position.PortfolioName = "BitfinexFuturesPortfolio";
                    position.SecurityNameCode = positionArray[0].ToString();
                    position.ValueCurrent = Math.Round(positionArray[2]?.ToString().ToDecimal() ?? 1, 4);
                    position.UnrealizedPnl = Math.Round(positionArray[6]?.ToString().ToDecimal() ?? 0, 6);
        ...
        private void UpdatePortfolio(string json)
        {
            try
            {
                ...
                if (wallet[0].ToString() == "margin")
                {
                    ...
                    position.PortfolioName = "BitfinexFuturesPortfolio";
                    position.SecurityNameCode = wallet[1].ToString();
                    position.ValueBegin = Math.Round(wallet[2]?.ToString().ToDecimal() ?? 0, 4);
